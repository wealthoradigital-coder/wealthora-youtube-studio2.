...
# Set up the page config to look like a premium app
st.set_page_config(
    page_title="Wealthora YouTube Studio v4",
    page_icon="👑",
    layout="wide",
    initial_sidebar_state="collapsed"
)

# Optional: Inject minimal CSS to hide Streamlit header padding for an immersive app feel
st.markdown("""
    <style>
...
# Your full HTML string goes inside this multi-line variable
html_code = """
<!DOCTYPE html>
<html lang="en">
<head>
...
# Render full screen HTML canvas inside Streamlit
